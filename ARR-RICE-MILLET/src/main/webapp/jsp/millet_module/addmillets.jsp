                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="selcategory" id="selcategory" maxlength="500" data-live-search="true"  required>
                                                                        ...
                                                                        <option  value="rice" >Millets</option>
                                                                        <option value="basmathirice">Millets Rice</option>
                                                                        <option value="idlydosa">Millets-Maavu</option>
                                                                        <option value="wheat">Millets-Ravai</option>
                                                                        <option  value="rice" >Ragi</option>
                                </select>
                            </div>
                        </div>
